...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "http://ALL.trollpay.com/explorer/?%s|http://ALL.trollpay.com/explorer/?%s|http://ALL.trollpay.com/explorer/?%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "http://ALL.trollpay.com/explorer/?%s|http://ALL.trollpay.com/explorer/?%s|http://ALL.trollpay.com/explorer/?%s").toString();
