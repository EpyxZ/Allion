    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("TrollPayCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  alliond [options]                     " + "\n" +
                  "  alliond [options] <command> [params]  " + _("Send command to -server or alliond") + "\n" +
                  "  alliond [options] help                " + _("List commands") + "\n" +
                  "  alliond [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: alliond.pid)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    SoftSetArg("-addnode", "ALL.trollpay.com");
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s.  Allion is probably already running."), strDataDir.c_str()));
